...
const logo = (
  <div className="flex justify-center items-center" title="AutoFormAI">
    <Image src="/favicon.png" alt="y2mp3 | youtube to mp3 converter" width={40} height={40} />
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex justify-between flex-wrap gap-10">
        <p className="text-sm">
          Copyright © {new Date().getFullYear()} EzyMp3. All
          rights reserved.
          {/* <br />
        ...
        <div className="flex flex-col gap-4 lg:items-end">
          <ul className="flex gap-5">
            {[
              { url: "https://github.com/happydrew/youtubetomp3", icon: GitHubIcon },
...
const config: DocsThemeConfig = {
  ...
  head: function useHead() {
    ...
    const title = `${pageTitle}${path === "/" ? "" : " | Nyt Connections Hints"}`

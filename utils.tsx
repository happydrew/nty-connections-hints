export { wait, isValidNumber, validEmailFormat, validatePasswordStrengthMid ,validYoutubeUrl,to2DArray};
...
function to2DArray<T>(arr: T[], groupSize: number): T[][] {
  const result: T[][] = [];
  
  for (let i = 0; i < arr.length; i += groupSize) {
    result.push(arr.slice(i, i + groupSize)); // 分组并推入结果数组
  }
